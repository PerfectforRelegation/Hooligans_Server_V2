package com.joh.core.user.service;

import com.joh.core.user.dto.kakao.SocialUserRequest;
import com.joh.core.user.model.User;
import com.joh.core.user.exception.UserEmailUpdateException;
import com.joh.core.user.exception.UserNotFoundException;
import com.joh.core.user.exception.UserRegistrationException;
import com.joh.core.user.repository.UserRepository;
